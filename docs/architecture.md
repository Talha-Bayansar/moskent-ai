...
- organization role editing is permissions-only: the role name is treated as immutable after creation so member assignments remain tied to the same Better Auth role key
