...
| --- | --- | --- |
| Organization and user foundation | in progress | Better Auth backend foundation now includes email/password, the organization plugin, dynamic per-organization roles, and the first organization creation flow at `/organizations/new`. Broader organization management workflows and UI are still `TBD`. |
